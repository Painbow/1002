...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.text_label_11.setGeometry(QtCore.QRect(420, 20, 101, 41))
        ...
        self.text_label_12.setGeometry(QtCore.QRect(420, 60, 101, 41))
    ...
    def accept2(self):
        ...
        # Error messages
            ...
            if (((self.text_box_2.toPlainText())+(self.text_box_3.toPlainText())).isalnum() is False):
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Critical)
                msg.setText("Error")
                msg.setInformativeText('Invalid Input')
