...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.text_label.setGeometry(QtCore.QRect(20, 100, 101, 16))
        self.text_label.setObjectName("text_label")

        self.default_button = QtWidgets.QDialogButtonBox(self.tab_2)
        self.default_button.setGeometry(QtCore.QRect(20, 240, 131, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.default_button.setStandardButtons(QtWidgets.QDialogButtonBox.RestoreDefaults)
